...
const DEMO_PRODUCT_ID = "prod-heysalad-tote";
const DEMO_PUBLIC_ID = "heysalad-reusable-tote-bag";
const now = new Date().toISOString();

const demoPassport: ProductPassport = {
  id: DEMO_PRODUCT_ID,
...
const draftPassport: ProductPassport = {
...
const mockDocuments: PassportDocument[] = [
  {
    id: "doc-1",
...
export function getSeedData() {
  return { passports: [demoPassport, draftPassport], documents: mockDocuments };
}
